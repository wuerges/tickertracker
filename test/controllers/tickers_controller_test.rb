...
class TickersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticker" do
    assert_difference('Ticker.count') do
      post tickers_url, params: { ticker: { description: @ticker.description, ticker: @ticker.ticker, url: @ticker.url } }
    end
  ...
  test "should update ticker" do
    patch ticker_url(@ticker), params: { ticker: { description: @ticker.description, ticker: @ticker.ticker, url: @ticker.url } }
